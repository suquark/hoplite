...
cp mpi/reduce.c /home/ubuntu/efs/mpitutorial/tutorials/mpi-reduce-and-allreduce/code/reduce_avg.c
pushd /home/ubuntu/efs/mpitutorial/tutorials/mpi-reduce-and-allreduce/code/
make
popd
...
mpirun --map-by ppr:1:node -hosts $all_hosts /home/ubuntu/efs/mpitutorial/tutorials/mpi-reduce-and-allreduce/code/reduce_avg $[$1/4]
